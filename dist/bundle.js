...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CarListCtrl = __webpack_require__(300);

	var _CarListCtrl2 = _interopRequireDefault(_CarListCtrl);

	var _CarListModel = __webpack_require__(307);

	var _CarListModel2 = _interopRequireDefault(_CarListModel);

	var _CarListView = __webpack_require__(309);

	var _CarListView2 = _interopRequireDefault(_CarListView);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _jquery2.default)(function () {
	  var model = new _CarListModel2.default();
	  var view = new _CarListView2.default(model, {
	    tableContainer: '#app',
	    addCar: '#add-car',
	    addOwner: '#add-owner'
	  }, {
	  ...
	  var ctrl = new _CarListCtrl2.default(model, view); // eslint-disable-line
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createCar = __webpack_require__(302);

	var _createOwner = __webpack_require__(306);
	...
	var CarListCtrl = function () {
	  function CarListCtrl(model, view) {
	    var _this = this;

	    _classCallCheck(this, CarListCtrl);
	    ...
	    // Слушатели view
	    this._view.createCarCmd.attach(function () {
	      return _this.createCar();
	    });
	    this._view.createOwnerCmd.attach(function (carId) {
	      return _this.createOwner(carId);
	    });
	  }

	  _createClass(CarListCtrl, [{
	    key: 'createCar',
	    value: function createCar() {
	      var form = new _createCar.CreateCar('#createCarForm');
	      form.show();
	      form.process().then(_api2.default.createCarRequest).then(this._model.addCar).catch(function (err) {
	        console.log(err);
	    ...
	    key: 'createOwner',
	    value: function createOwner(carId) {
	      var _this2 = this;

	      var form = new _createOwner.CreateOwner('#createOwnerForm', carId);
	      form.show();
	      form.process().then(_api2.default.createOwnerRequest).then(function (owner) {
	        return _this2._model.addOwner(carId, owner);
	      }).catch(function (err) {
	        console.log(err);
	        alert('Произошла ошибка. Попробуйте позже');
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rambda = __webpack_require__(303);

	var _base = __webpack_require__(304);

	var _predicates = __webpack_require__(305);
	...
	var FIRST_CAR_YEAR = 1768;

	var CreateCar = function (_Form) {
	  _inherits(CreateCar, _Form);

	  function CreateCar() {
	    _classCallCheck(this, CreateCar);

	    return _possibleConstructorReturn(this, (CreateCar.__proto__ || Object.getPrototypeOf(CreateCar)).apply(this, arguments));
	  }

	  _createClass(CreateCar, [{
	    key: 'show',
	    value: function show() {
	      this.reset();
	    ...
	    get: function get() {
	      return {
	        id: _predicates.isInt,
	        model: !_rambda.isEmpty,
	        brand: !_rambda.isEmpty,
	        year: (0, _rambda.both)(_predicates.isInt, (0, _rambda.gte)(_rambda.__, FIRST_CAR_YEAR))
	      };
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InvalidForm = function InvalidForm(form, errors) {
	  _classCallCheck(this, InvalidForm);
	...
	var Form = function () {
	   ...
	   */
	  function Form(formSel, validators) {
	    var _this = this;

	    _classCallCheck(this, Form);

	    this._form = (0, _jquery2.default)(formSel);
	    this._validators = validators || this.constructor.defaultValidators;

	    this._submitPromise = new Promise(function (resolve) {
	      _this.form.submit(function (event) {
	        event.preventDefault();
	        resolve(_this.toObject);
	      });
	    });
	  }
	  ...
	  _createClass(Form, [{
	    ...
	    value: function validate(state) {
	      ...
	      var errors = (0, _rambda.pipe)((0, _rambda.mapObjIndexed)(function (i, field, obj) {
	        var fn = _this2._validators[field] || (0, _rambda.defaultTo)(undefined);
	        return fn(state[field], obj);
	      }), (0, _rambda.filter)(!_predicates.isUndefined))(state);

	      if ((0, _predicates.isFilledObject)(errors)) {
	    ...
	    value: function process() {
	      return this._submitPromise.then(this.validate);
	    }
	  }, {
	    key: 'reset',
	    ...
	    get: function get() {
	      ...
	      return this.mixinFields ? _extends({}, this.mixinFields, obj) : obj;
	    }
	  }], [{
	    key: 'defaultValidators',
	    get: function get() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isUndefined = function isUndefined() {
	  for (var _len = arguments.length, xs = Array(_len), _key = 0; _key < _len; _key++) {
	    xs[_key] = arguments[_key];
	  }

	  return xs.some(function (el) {
	    return typeof el === 'undefined';
	  });
	};
	var isFilledObject = (0, _rambda.either)(isUndefined, _rambda.isEmpty);
	var isHighlightedEl = function isHighlightedEl(el) {
	  return el.highlighting;
	};
	...
	exports.default = {
	  ...
	  isHighlightedEl: isHighlightedEl,
	  isInt: isInt
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreateOwner = function (_Form) {
	  _inherits(CreateOwner, _Form);

	  function CreateOwner(formSel, carId) {
	    _classCallCheck(this, CreateOwner);

	    var _this = _possibleConstructorReturn(this, (CreateOwner.__proto__ || Object.getPrototypeOf(CreateOwner)).call(this, formSel));

	    _this.mixinFields = { carId: carId };
	    return _this;
	  }

	  _createClass(CreateOwner, [{
	    key: 'show',
	    value: function show() {
	      _get(CreateOwner.prototype.__proto__ || Object.getPrototypeOf(CreateOwner.prototype), 'reset', this).call(this);
	      this.form.modal('show');
	    }
	  }, {
	    key: 'close',
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @returns {Object}
	 */
	var createIndex = (0, _rambda.indexBy)((0, _rambda.prop)('id'));

	var DEFAULT_OPTIONS = {
	  highlightingTimeout: 1000
	};

	var CarListModel = function () {
	  function CarListModel() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

	    _classCallCheck(this, CarListModel);

	    this._state = state;
	    this._options = (0, _rambda.merge)(DEFAULT_OPTIONS, options);

	    // Блок инициализации наблюдателей
	    this.carAdded = new _event2.default(this);
	    this.carUpdated = new _event2.default(this);
	    this.stateReseted = new _event2.default(this);
	  }
	  ...
	  _createClass(CarListModel, [{
	    key: 'addCar',
	    value: function addCar(carInfo) {
	      var _this = this;
	      ...
	      if ((0, _predicates.isUndefined)(id, brand, model, year)) {
	        throw new ReferenceError('Невозможно создать автомобиль');
	      }

	      this._state[id] = { id: id, brand: brand, model: model, year: year, highlighting: true };
	      this.carAdded.notify({ car: this._state[id] });

	      setTimeout(function () {
	        _this._state[id].highlighting = undefined;
	        _this.carUpdated.notify({ id: id });
	    ...
	    key: 'addOwner',
	    value: function addOwner(idCar, owner) {
	      var _this2 = this;

	      if ((0, _predicates.isUndefined)(idCar, owner)) {
	      ...
	      setTimeout(function () {
	        _this2._state[idCar].highlighting = undefined;
	        _this2.carUpdated.notify({ id: idCar });
	      }, this._options.highlightingTimeout);
	    }
	    ...
	    value: function reset(state) {
	      var oldState = _extends({}, this._state);
	      this._state = Array.isArray(state) ? createIndex(state) : _extends({}, state);

	      if ((0, _predicates.isFilledObject)(this._state)) {
	        var highlightedElems = (0, _rambda.pipe)((0, _rambda.filter)(_predicates.isHighlightedEl), _rambda.keys)(oldState);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sortByFieldLens = (0, _rambda.lensPath)(['_sortBy', 'field']);
	var sortOrderFlagLens = (0, _rambda.lensPath)(['_sortBy', 'notRevers']);

	var carToString = (0, _rambda.curry)(function (fields, car) {
	  var html = (0, _rambda.join)('', (0, _rambda.map)(function (field) {
	    return '<td>' + (car[field] || '') + '</td>';
	  }, fields));
	...
	var CarListView = function () {
	  function CarListView(model, elems, viewConf) {
	    var _this = this;

	    _classCallCheck(this, CarListView);
	    ...
	    this._elements.tableContainer.find('th').click(function (event) {
	      var field = (0, _jquery2.default)(event.currentTarget).data('field');
	      if ((0, _rambda.view)(sortByFieldLens, _this) === field) {
	        // если поле сортировки текущее инвертируем порядок
	        (0, _rambda.over)(sortOrderFlagLens, _rambda.not, _this);
	      } else {
	        // устанавливаем новое поле сортировки и порядок по умолчанию
	        (0, _rambda.set)(sortByFieldLens, field, _this);
	        (0, _rambda.set)(sortOrderFlagLens, true, _this);
	      }
	      _this.render();
	    });
	    // Добавление автомобиля
	    this._elements.addCar.click(function () {
	      return _this.createCarCmd.notify();
	    });
	    // Добавление собственника
	    this._elements.addOwner.click(function (event) {
	      var carId = (0, _jquery2.default)(event.currentTarget).parent('tr').data('car-id');
	      _this.createOwnerCmd.notify({ carId: carId });
	    });

	    // слушатели модели
	    (0, _rambda.map)(function (event) {
	      _this._model[event].attach(function () {
	        _this.rebuild();
	      });
	    }, ['carAdded', 'carUpdated', 'stateReseted']);
	  }

	  _createClass(CarListView, [{
	    key: 'sortedCar',
	    value: function sortedCar() {
	      var field = (0, _rambda.view)(sortByFieldLens, this);
	      var notReverse = (0, _rambda.view)(sortByFieldLens, this);
	      var orderFn = notReverse ? _rambda.ascend : _rambda.descend;
	      var sortFn = (0, _rambda.sortWith)([orderFn((0, _rambda.prop)(field))]);
	      return sortFn((0, _rambda.values)(this._model.state));
	    }
	  }, {
	    key: 'render',
	    ...
	    value: function renderToString() {
	      var head = this.renderToStringHead();
	      var body = this.renderToStringBody();
	      return '<table class="' + this._viewConf.tableClass + '">' + head + ' ' + body + '</table>';
	    }
	  }, {
	    key: 'renderToStringHead',
	    value: function renderToStringHead() {
	      var _this2 = this;

	      var order = this._viewConf.columns.order;
	      var th = function th(field) {
	        var fieldTitle = _this2._viewConf.columns.data[field];
	        return '<th data-field="' + field + '">' + fieldTitle + '</th>';
	      };
	      var thList = (0, _rambda.join)('', (0, _rambda.map)(th, order));
	      return '<thead>' + thList + '</thead>';
	    }
	  }, {
	    key: 'renderToStringBody',
	    value: function renderToStringBody() {
	      var orderColumns = this._viewConf.columns.order;
	      var state = this.sortedCar;
	      var trList = (0, _rambda.pipe)((0, _rambda.map)(carToString(orderColumns)), (0, _rambda.join)(''))(state);
